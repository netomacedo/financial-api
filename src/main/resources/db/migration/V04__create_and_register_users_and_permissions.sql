...
INSERT INTO user (code, name, email, password) values (1, 'Administrator', 'admin@algamoney.com', '$2a$10$X607ZPhQ4EgGNaYKt3n4SONjIv9zc.VMWdEuhCuba7oLAL5IvcL5.');
...
INSERT INTO permission (code, description) values (3, 'ROLE_CREATE_PEOPLE');
INSERT INTO permission (code, description) values (4, 'ROLE_REMOVE_PEOPLE');
INSERT INTO permission (code, description) values (5, 'ROLE_SEARCH_PEOPLE');

INSERT INTO permission (code, description) values (6, 'ROLE_CREATE_LAUNCH');
